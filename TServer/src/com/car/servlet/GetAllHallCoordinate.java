...
public class GetAllHallCoordinate extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public GetAllHallCoordinate() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			String jsonString = JsonTools.createJsonString("CarCoordinateInfo", list);
			out.print(jsonString);
		}catch(Exception e){
			e.printStackTrace();
			System.out.print("fail get data from DB");
		}
