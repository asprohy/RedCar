...
public class GetAllCarBend extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public GetAllCarBend() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		response.setContentType("text/html");
		PrintWriter out = response.getWriter();
		System.out.print("’‚ «GetAllCarBend");
		List<CarBendInfo> list = new ArrayList<CarBendInfo>();
		MapDaoImpl dao = new MapDaoImpl();
		try{
			list = dao.getAllBendInfo();
			String jsonString = JsonTools.createJsonString("CarBendInfo", list);
