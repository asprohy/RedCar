...
public class GetTrafficInfo extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			List<CongestionCoordinate> list = trafficInfo.JudgeCongestion();//按单个车来得到坐标对，放到一个list
			String jsonString = JsonTools.createJsonString("Coordinate", list);
			out.print(jsonString);
		}catch(Exception e){
			out.print("fail get TrafficList");
		}
		out.flush();
		out.close();
	}
