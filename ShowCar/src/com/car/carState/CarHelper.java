...
public class CarHelper {
	...
	//找到最近一条数据
    	String sql = "select car_id, group_id, history_hall_count, dirive_distance from car_history_data where car_id = " + id + " and max(send_time)";
    	DBHelper db = new DBHelper(sql);
    	ResultSet ret;
    	int carId = 0;
    	int groupId = 0;
	...
	try {
    	...
    	String sql1 = "select dirive_distance from car_history_data where history_hall_count = " + hallCount + " car_id = " + carId + " and min(distance)";
